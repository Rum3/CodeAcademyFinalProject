    ...
    <body class="mb-48">
        ...
        {{----------------------------------------------------------- Admin Home Page -----------------------------------------------------------}}
            ...
            <a href ="{{ route('create') }}" id="tranings" class="text-white bg-none hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm-40 px-10 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Tranings</a>
            <a href = "{{ route('StudentsForm') }}" id="students" class="text-white bg-none hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm-40 px-10 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Students</a>
            ...
            <a href = "{{ route('show-pages') }}" id="pages" class="text-white bg-none hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm-40 px-10 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Pages</a>
        ...
        {{----------------------------------------------------------- Student Home Page -----------------------------------------------------------}}
            ...
            <nav class="flex justify-even items-center mb-4 bg-laravel h-20">
            <button id="dropdownHoverButton" class="text-white bg-none hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm-40 px-10 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button"><a href="/tranings">Tranings</a></button>
            <button id="dropdownHoverButton" class="text-white bg-none hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm-40 px-10 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button"><a href="/students">Students</a></button>
            <button id="dropdownHoverButton" class="text-white bg-none hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm-40 px-10 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button"><a href="/grades">Grades</a></button>
              <div class="text-red-200 text-2xl w-50">
                  <a href="/" ><h1>CodeAcademy</h1></a>
              </div>
