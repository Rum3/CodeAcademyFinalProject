...
<div class="max-w-2xl mx-auto p-6 bg-gray-200">
      ...
      <form  action="{{ route('detailStore')}}" method="post">
        ...
        @endif
         ...
         <input type="text" id="language" value="" name="language[]" value="{{ isset($student) ? $student->language : '' }}" class="w-2/5 py-2 px-4 mb-4 rounded border border-gray-300" placeholder="Език" required>  
          <input type="text" name="score[]" value="{{ isset($student) ? $student->score : '' }}" id="languageScore" class="w-2/5 py-2 px-4 mb-4 rounded border border-gray-300" placeholder="Оценка на езика" required>
   ...
   <input type="text" id="repository" name="repository[]" value="{{ isset($student) ? $student->repository : '' }}" class="w-4/5 py-2 px-4 mb-4 rounded border border-gray-300" placeholder="Repository" required>
      ...
      <input type="text" id="messenger" name="messenger" placeholder="messenger name" class="w-full py-2 px-4 mb-4 rounded border border-gray-300">
        ...
        <input type="text" id="username" class="w-4/5 py-2 px-4 mb-4 rounded border border-gray-300" placeholder="username">
        <button type="button" onclick="addUsername()" class="w-1/8 py-2 px-4 mb-4 rounded border border-gray-300 bg-green-500 text-white">+</button>
