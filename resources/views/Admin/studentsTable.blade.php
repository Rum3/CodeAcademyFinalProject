        ...
        <tbody class="divide-y divide-gray-100 border-t border-gray-100">
            ...
            <tr class="{{ $loop->iteration % 2 === 0 ? 'bg-gray-200' : '' }}">
                ...
                <td class="px-6 py-4 flex items-center">
                    ...
                    <a href="{{ route('grades.form') }}" class="text-blue-500 mr-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-folder transform hover:scale-110" viewBox="0 0 16 16">
